...
var formButton = document.querySelector('#newBook');
var cancelForm = document.querySelector('#cancelForm');
var bookForm = document.querySelector('#bookForm');

bookForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var newBook = new Book(this.elements.title.value, this.elements.author.value, this.elements.pages.value, this.elements.read.value);
...
function renderPage() {
  ...
  myLibrary.forEach(function (book) {
    ...
    readButton.addEventListener('click', function (e) {
      var bookIndex = e.target.parentNode.dataset.id;
...
var book1 = new Book("Headlopper", "Andrew M", 200, true);
var book2 = new Book("The Golden Compass", "Idk", 304, false);
